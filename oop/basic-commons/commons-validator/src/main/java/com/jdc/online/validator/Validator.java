...
public interface Validator {
	...
	static Validator getInstance() {
		return new OneStopValidator(new FieldValidatorForMaxLength(), new FieldValidatorForMaxValue(),
				new FieldValidatorForMinLength(), new FieldValidatorForMinValue(), new FieldValidatorForNotBlank(),
